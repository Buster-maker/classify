from modules import bottleneck, conv2d_fixed_padding, get_filters, batch_norm_relu, initial_conv, concat,variable,bias
...
class FishNets:
    def __init__(self, num_classes, network_planes=None, num_res_blks=None,
                 num_trans_blks=None, data_format='channels_last'):
        if not data_format:
            data_format = (
